        ...
        <div className="mx-auto max-w-6xl space-y-8 pt-12">
          <a href="https://github.com/balshaer/gradients-css" target="_blank">
            <div className="flex w-full items-center justify-center">
              ...
              >
                <AnimatedShinyText className="inline-flex max-md:text-xs items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
